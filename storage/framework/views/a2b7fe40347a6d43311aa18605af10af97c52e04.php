        ...
        <div class="container-fuild">
            <div class="row">
                ...
                <div class="col-12 d-flex justify-content-center">
                    <!-- <div class="alert alert-success"><?php echo e(Session::get('exam_success')); ?></div> -->
                                ...
                                <div class="login-main-container">
                                    <div class="thankyou-wrapper">
                                        <h1><img src="http://montco.happeningmag.com/wp-content/uploads/2014/11/thankyou.png" alt="thanks" /></h1>
                                            ...
                                            <p>Good Luck</p>
                                            <a href="<?php echo e(route('index')); ?>">Back to home</a>
                                            <div class="clr"></div>
                                        </div>
                                        <div class="clr"></div>
                                    </div>
...
</html><?php /**PATH /var/www/html/resources/views/exams/result.blade.php ENDPATH**/ ?>