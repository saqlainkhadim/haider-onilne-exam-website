                    ...
                    <div class="card">
                        <div class="card-body" id="card-body">
                            <form class="row g-3 mt-3" name="create_exam_form" method="post"
                                  action="<?php echo e(route('admin.exams.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="col-12">
                                ...
                                <div class="col-12" id="dynamicInputFreeTextFields">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function showSection() {
            const html = `
            <div class="col-12">
                <label for="categorySelection-${section_row}" class="form-label">Exam Category Selection</label>
                <select class="form-control" name="categorySelection-${section_row}" id="categorySelection-${section_row}">
                    <option value="0">
                        Select Pattern
                    </option>
                    <option value="1">
            ...
            <div class="col-12" id="categorySelectionInput-${section_row}">
                <label for="categorySelectionType-${section_row}" class="form-label">Pattern Type</label>
                <select class="form-control" name="categorySelectionType[]-${section_row}" multiple=""
                        id="categorySelectionType-${section_row}">
            ...
            <div class="col-12">
                <label for="InputFieldCount-${section_row}" class="form-label">How many free text fields</label>
                <input type="number" min="1" maxlength="100"
                name="inputCount-${section_row}" value=""
                class="form-control" id="InputFieldCount-${section_row}"
                placeholder="How many free text fields">
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/exams/create.blade.php ENDPATH**/ ?>