                    ...
                    <div class="card">
                        <div class="card-body" id="card-body">
                            <form class="row g-3 mt-3" name="register_exam_form" method="post"
                                action="<?php echo e(route('admin.exams.assign_student.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function loadStudents() {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "<?php echo e(route('admin.exams.load_students')); ?>",
                data: {
                    exam_id
                },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/exams/assign_student.blade.php ENDPATH**/ ?>